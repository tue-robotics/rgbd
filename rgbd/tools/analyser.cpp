...
int main(int argc, char **argv) {
  ...
  while (ros::ok()) {
    ...
    if (depth.data) {
      ...
      std::cout << "        fx, fy = " << cam_model.getFocalLengthX() << ", "
                << cam_model.getFocalLengthY() << std::endl;
      std::cout << "        cx, cy = " << cam_model.getOpticalCenterX() << ", "
                << cam_model.getOpticalCenterY() << std::endl;
